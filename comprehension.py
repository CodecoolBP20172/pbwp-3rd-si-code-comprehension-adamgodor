...
print('Hello! What is your name?') # print the following str to console
...
while guessesTaken < 6: # initialize a while loop
    ...
    guess = int(guess) # convert the 'guess' string into a integer

    guessesTaken += 1 # add 1 to the 'guessesTaken' value

    if guess < number: # initialize an if statment
        print('Your guess is too low.') # if the statement ('guess' var is smaller than 'number' var) true, print the following str

    if guess > number: # initialize an if statment
        print('Your guess is too high.') # if the statement ('guess' var is bigger than 'number' var) true, print the following str
